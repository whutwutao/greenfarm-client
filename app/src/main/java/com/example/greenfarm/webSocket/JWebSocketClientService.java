package com.example.greenfarm.webSocket;
...
import com.example.greenfarm.utils.WebSocketUtil;
...
public class JWebSocketClientService extends Service {
    ...
    private Notification getNotification() {
        Notification.Builder builder = new Notification.Builder(this,"channel_id")
                .setSmallIcon(R.mipmap.icon_header)
                .setContentTitle("绿色农场")
                .setContentText("");
    ...
    private void initSocketClient() {
        URI uri = URI.create(WebSocketUtil.getWebSocketUrl("userId",String.valueOf(UserManager.currentUser.getId())));
...
//        Message message = new Gson().fromJson(content, Message.class);
        ...
        intent.putExtra("friend",new Gson().toJson(sender));
