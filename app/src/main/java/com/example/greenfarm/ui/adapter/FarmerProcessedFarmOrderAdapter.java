...
public class FarmerProcessedFarmOrderAdapter extends BaseQuickAdapter<FarmOrderBean, BaseViewHolder> {
    private Context mContext;

    public FarmerProcessedFarmOrderAdapter(@Nullable List<FarmOrderBean> data, Context mContext) {
    ...
    protected void convert(BaseViewHolder helper, FarmOrderBean item) {
        ...
        helper.setText(R.id.tv_farm_order_time,"处理时间："+dateText);
    }
}
